...
✅
✅
✅ (trusted on uplink to router)
Busan (L3)
✅ (violation: restrict)
❌ removed
❌ not applicable on L3
Daegu (L3)
✅ (violation: protect)
❌ removed
❌ not applicable on L3
DHCP Snooping and DAI are Layer 2 features tied to switchport/VLAN context, so they were only fully implemented at Seoul HQ (the L2 switch). On the Busan and Daegu L3 switches, DHCP Snooping was initially attempted but ended up removed — see Known Limitations below.
9. Known Limitations
